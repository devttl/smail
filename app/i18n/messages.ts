...
const en: Dictionary = {
	home: {
		title: "cleanorapi.com Temporary Email (24h) - Free Temp Mail for OTP & Sign-Ups",
		description:
			"Generate free temporary email (temp mail) instantly on cleanorapi.com. Use a 24-hour disposable inbox for OTP verification, quick sign-ups, and spam control.",
		keywords:
			"smail, smail temp mail, temporary email, temp mail, disposable email, temporary email generator, 24 hour temporary email, no registration email, otp email, cleanorapi.com",
...
const zh: Dictionary = {
	home: {
		title: "临时邮箱生成器（24小时）- 免费一次性邮箱免注册收验证码 | cleanorapi.com",
		description:
...
const es: Dictionary = {
	home: {
		title: "Correo temporal gratis 24h sin registro para OTP | cleanorapi.com",
		description:
		...
		keywords:
			"correo temporal, correo temporal gratis, email temporal, email desechable, temp mail, 24 horas, sin registro, codigo otp, cleanorapi.com",
...
const fr: Dictionary = {
	home: {
		title: "Email temporaire gratuit 24h sans inscription | cleanorapi.com",
		description:
		...
		keywords:
			"email temporaire, email jetable, temp mail, 24h, sans inscription, code otp, boite mail temporaire, cleanorapi.com",
...
const de: Dictionary = {
	home: {
		title: "Temporäre E-Mail kostenlos (24h) ohne Registrierung | cleanorapi.com",
		description:
			"Kostenloser Temp-Mail-Generator für Registrierungen und OTP-Codes. Erstelle sofort ein 24h Wegwerf-Postfach ohne Konto.",
		keywords:
			"temporäre email, wegwerf-email, temp mail, 24h email, ohne registrierung, otp code email, cleanorapi.com",
...
const ja: Dictionary = {
	home: {
		title: "一時メール（24時間）無料・登録不要でOTP受信 | cleanorapi.com",
		description:
			"無料の一時メール（temp mail）生成サービス。登録不要で24時間の使い捨て受信箱を作成し、認証コードを受け取れます。",
		keywords:
			"一時メール, 使い捨てメール, テンプメール, 24時間メール, 登録不要メール, OTP, 認証メール, cleanorapi.com",
		heroTag: "一時メールボックス",
...
const ko: Dictionary = {
	home: {
		title: "임시 이메일 24시간 무료, 가입 없이 OTP 수신 | cleanorapi.com",
		description:
			"무료 임시 이메일(temp mail) 생성기. 가입 없이 24시간 일회용 메일함을 만들고 인증 코드(OTP)를 빠르게 받으세요.",
		keywords:
			"임시 이메일, 일회용 이메일, 템프 메일, 24시간 메일, 가입 없는 이메일, OTP 메일, 인증 메일, cleanorapi.com",
		heroTag: "임시 메일함",
...
const ru: Dictionary = {
	home: {
		title: "Временная почта 24 часа бесплатно без регистрации | cleanorapi.com",
		description:
			"Бесплатный temp mail для регистраций и OTP-кодов. Создайте одноразовый почтовый ящик на 24 часа без аккаунта.",
		keywords:
			"временная почта, одноразовая почта, temp mail, почта 24 часа, без регистрации, otp код, cleanorapi.com",
...
const pt: Dictionary = {
	home: {
		title: "Email temporário grátis 24h sem cadastro para OTP | cleanorapi.com",
		description:
			"Gerador de temp mail grátis para cadastro e códigos OTP. Crie uma caixa descartável de 24h instantaneamente.",
		keywords:
			"email temporario, email temporário, email descartavel, temp mail, 24h, sem cadastro, codigo otp, cleanorapi.com",
...
const ar: Dictionary = {
	home: {
		title: "بريد مؤقت مجاني 24 ساعة بدون تسجيل لاستلام OTP | cleanorapi.com",
		description:
			"مولّد بريد مؤقت مجاني (temp mail) للتسجيل السريع ورموز OTP. أنشئ صندوقًا للاستخدام مرة واحدة لمدة 24 ساعة فورًا.",
		keywords:
			"بريد مؤقت, بريد مؤقت مجاني, بريد للاستخدام مرة واحدة, temp mail, بريد 24 ساعة, بدون تسجيل, رمز otp, cleanorapi.com",
		heroTag: "صندوق مؤقت",
