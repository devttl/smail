...
const SUPPORT_EMAIL = "support@cleanorapi.com";
...
const CONTACT_COPY: Record<Locale, ContactCopy> = {
	en: {
		metaTitle: "Contact | cleanorapi.com",
		metaDescription: "Contact cleanorapi.com support by email.",
		tag: "Support",
	...
	zh: {
		metaTitle: "联系我们 | cleanorapi.com",
		metaDescription: "通过邮箱联系 cleanorapi.com 支持团队。",
		tag: "支持",
		title: "联系支持团队",
		description:
	...
	es: {
		metaTitle: "Contacto | cleanorapi.com",
		metaDescription: "Contacta con soporte de cleanorapi.com por correo.",
		tag: "Soporte",
	...
	fr: {
		metaTitle: "Contact | cleanorapi.com",
		metaDescription: "Contacter le support cleanorapi.com par email.",
		tag: "Support",
	...
	de: {
		metaTitle: "Kontakt | cleanorapi.com",
		metaDescription: "Kontaktiere den cleanorapi.com Support per E-Mail.",
		tag: "Support",
	...
	ja: {
		metaTitle: "お問い合わせ | cleanorapi.com",
		metaDescription: "cleanorapi.com サポートへの連絡先メール。",
		tag: "サポート",
		title: "サポートへ連絡",
		description:
	...
	ko: {
		metaTitle: "문의하기 | cleanorapi.com",
		metaDescription: "cleanorapi.com 지원팀에 이메일로 문의하세요.",
		tag: "지원",
		title: "지원팀 문의",
	...
	ru: {
		metaTitle: "Контакты | cleanorapi.com",
		metaDescription: "Свяжитесь с поддержкой cleanorapi.com по email.",
		tag: "Поддержка",
	...
	pt: {
		metaTitle: "Contato | cleanorapi.com",
		metaDescription: "Entre em contato com o suporte da cleanorapi.com por email.",
		tag: "Suporte",
	...
	ar: {
		metaTitle: "اتصل بنا | cleanorapi.com",
		metaDescription: "تواصل مع دعم cleanorapi.com عبر البريد الإلكتروني.",
		tag: "الدعم",
